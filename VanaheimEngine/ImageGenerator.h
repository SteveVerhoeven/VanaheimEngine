...
class ImageGenerator final
{
	public:
		...
		static void GenerateImage(const std::vector<DirectX::XMFLOAT3>& map, const std::string& filePath, const DirectX::XMINT2& mapSize);
		static void GenerateImage(const std::vector<float>& map, const std::string& filePath, const DirectX::XMINT2& mapSize);
